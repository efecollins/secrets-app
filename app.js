...
passport.use(new GoogleStrategy({
    ...
    callbackURL: 'http://localhost:3001/auth/google/secrets'||'https://secret.cyclic.app/auth/google/secrets'||'https://lemon-dugong-gown.cyclic.app/auth/google/secrets'
},
